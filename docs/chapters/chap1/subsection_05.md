...
前述したように,
従来の機械学習をグラフにおける計算タスクに活用するためには,
ノードのベクトル表現をみつける必要がある. 図1.5に示したように,
この目的を達成するためには,
主に特徴量エンジニアリングと特徴量学習の2つの方法がある.
特徴量エンジニアリングはノードの次数の統計量のような,
手作業で設計された特徴量に依るが,
特徴量学習はノードの特徴量を自動的に学習させるものである.
ある後段のタスクにとってどのような特徴量が重要であるかについての予備知識は持っていないことが多いため,
特徴量エンジニアリングによる特徴量は後段タスクに最適でない可能性がある.
特徴量エンジニアリングのプロセスには膨大な人手が必要である. 一方,
特徴量学習は, 特徴量を自動的に学習するものであり,
後段タスクに沿うように学習プロセスを行う. そのため, 学習された特徴量は,
後段タスクに適している可能性が高く,
特徴量エンジニアリングによる特徴量と比べて優れた性能を得られることが多い.
また, このプロセスは人間の介入を最小限に抑え,
新しいタスクに容易に適応することができる. したがって,
グラフにおいては特徴量学習が精力的に研究され,
様々な場面や要請に対応するために, 様々な手法が提案されている.
これらの技術を,
グラフにおける特徴量選択とグラフにおける表現学習に大別して考える.
前者は無関係で冗長なノード特徴量を排除することを目的とし,
後者は新しいノード特徴量の集合を生成することを目的としている. 本節では,
これら2つの技術群について簡単にレビューすることで,
グラフ深層学習の理解の助けになるような一般的かつ歴史的な文脈を紹介する.

<figure>

<img src="./fig/fig1_5.png" width="100%"/>

<figcaption>図1.5 テスト</figcaption>

</figure>

### グラフにおける特徴量選択

実世界のデータは高次元であることが多く, 特定のタスクを考慮する場合には,
ノイズや無関係なもの, 冗長な特徴量(または次元)などが含まれている.
...
深層学習によって劇的に加速した. この小節では,
「浅いモデル」から深層モデルまでの簡単な歴史的概要を説明する.

初期には, グラフにおける表現学習は, スペクトラルクラスタリング（Shi and
Malik、2000; Ng et al., 2002）, グラフベースの次元削減（Belkin and
...
Word2vecがさまざまな自然言語処理タスクで大成功を収めたことから,
...
3.  有向グラフ（Ou et al., 2016）, 異種グラフ（Chang et al., 2015; Dong
    ...
    Li et al., 2017a）などの複雑なグラフのためのフレームワークを設計する
