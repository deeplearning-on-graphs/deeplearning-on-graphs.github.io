...
<a href="mailto:deeplearning.on.graphs@gmail.com?subject=誤植報告&body=「グラフ深層学習」担当者%0D%0A%0D%0A■ページ番号：p.◯◯%0D%0A■誤：%0D%0A✗✗✗✗✗✗%0D%0A%0D%0A■正（わかれば）：%0D%0A◯◯◯◯◯%0D%0A%0D%0A■備考：%0D%0A%0D%0A※訳者より%0D%0Aこの度はご迷惑をおかけしてすみません．%0D%0A本メールへの返信はいたしません．内容を吟味し次版への対応を検討いたします．">メールはこちら</a>
